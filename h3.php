...
session_start();
$usr=$_SESSION['usr'];
$sql="UPDATE prog SET html=3 WHERE email='$usr';";
$result=mysqli_query($link,$sql);
 ?>
    ...
    */
    var quiz = [
        {
            "question"      :   "Q1: Which tag is used to insert image",
        ...
        {
            "question"      :   "Q2: what attribute of table specifies size of table cells?",
            ...
            "correct"       :   "rowspan and colspan",
            "explanation"   :   "",
        },
        {
            "question"      :   "Q3: which tag is used to specify type of document ?",
