...
session_start();
$usr=$_SESSION['usr'];
$sql="UPDATE prog SET html=5 WHERE email='$usr';";
$result=mysqli_query($link,$sql);
 ?>
    ...
    */
    var quiz = [
        {
            "question"      :   "Q1: html5 has this exculsive tag",
        ...
        {
            "question"      :   "Q2: html5 has user defined tags",
        ...
        {
            "question"      :   "Q3: canvas was made by apple to subbstitute?",
