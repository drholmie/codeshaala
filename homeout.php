			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            <li class="active"><a href="homeout.php" data-nav-section="home"><span>Home</span></a></li>
		            <li ><a href="login.php"><span>Course Catalog</span></a></li>
		            <li ><a href="login.php"><span>Forum</span></a></li>
		            <li ><a href="login.php"><span>Log-In</span></a></li>
		            <li ><a href="login.php" data-nav-section="contact"><span>Sign-up</span></a></li>
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate">Welcome to CodeShaala</h1>
			...
			<div class="row row-bottom-padded-lg">
				<div class="fh5co-block to-animate" style="background-image: url(images/img_10.jpg);">
					...
					<div class="fh5co-text">
						...
						<p><a href="login.html" class="btn btn-primary">Go!</a></p>
					</div>
				</div>
				<div class="fh5co-block to-animate" style="background-image: url(images/img_10.jpg);">
					<div class="overlay-darker"></div>
