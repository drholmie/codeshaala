				 ...
				 <a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
					 ...
					 <div id="navbar" class="navbar-collapse collapse">
						 <ul class="nav navbar-nav navbar-right">
							 <li class="active"><a href="homeout.html" data-nav-section="home"><span>Home</span></a></li>
							 <li ><a href="catalog.html"><span>Course Catalog</span></a></li>
							 <li ><a href="forum.html"><span>Forum</span></a></li>
							 <li ><a href="profile.html"><span>Profile</span></a></li>
							 <li ><a href="homeout.html"><span>logout</span></a></li>
...
session_start();
$usr=$_SESSION['usr'];
$sql="UPDATE prog SET html=4 WHERE email='$usr';";
$result=mysqli_query($link,$sql);
 ?>
    ...
    */
    var quiz = [
        {
            "question"      :   "Q1:canvas element is implemented in ?",
        ...
        {
            "question"      :   "Q2: video is inserted using?",
        ...
        {
            "question"      :   "Q3: which one of these is the correct herirachy ?",
            ...
            "correct"       :   "<html><head></head></html>",
            "explanation"   :   "",
        },
        {
            "question"      :   "Q4: which of the folloring are single tags ?",
        ...
        {
            "question"      :   "Q5: which one of these is a block tags ?",
