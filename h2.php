...
session_start();
$usr=$_SESSION['usr'];
$sql="UPDATE prog SET html=2 WHERE email='$usr';";
$result=mysqli_query($link,$sql);
 ?>
    ...
    */
    var quiz = [
        {
            "question"      :   "Q1: what tags is used to make links",
        ...
        {
            "question"      :   "Q2: what tag ensures maintains order of spacing given to the text by decloper",
        ...
        {
            "question"      :   "Q4: what tag specifies main structure of the document?",
