...
session_start();
$usr=$_SESSION['usr'];
$sql="UPDATE prog SET css=1 WHERE email='$usr';";
$result=mysqli_query($link,$sql);
 ?>
    ...
    */
    var quiz = [
        {
            "question"      :   "Q1: Which of the following has highest priority",
        ...
        {
            "question"      :   "Q3: property name used to modify color in stylesheets ?",
        ...
        {
            "question"      :   "Q4: the units used to scale an object with respect to current value ?",
        ...
        {
            "question"      :   "Q5: which is the outer most box of the box model ?",
