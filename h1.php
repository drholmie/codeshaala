...
session_start();
$usr=$_SESSION['usr'];
$sql="INSERT INTO prog VALUES('$usr',1);";
$result=mysqli_query($link,$sql);
 ?>
    ...
    */
    var quiz = [
        {
            "question"      :   "Q1: What is the fll form of WWW",
        ...
        {
            "question"      :   "Q3: which of the folloring are single tags ?",
        ...
        {
            "question"      :   "Q3: which one of these is a block tags ?",
